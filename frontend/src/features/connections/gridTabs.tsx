...
/**
 * The two tab panels that use AG Grid, loaded on demand.
 *
 ...
 * from exactly two places, both of them tabs the user has to click into: a
 * topic's (or partition's) Data tab, and a partition's Replicas tab. Everything
 * else — the cluster tree, the payload viewer, settings, publish — never touches
 * it, yet every one of them waited for it to parse before the window could
 * paint.
 *
 ...
 *
 * Kept in one module rather than a `lazy()` at each call site so both panels
